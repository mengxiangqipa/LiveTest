...
public final class MediaStore {
    ...
    public static final class Video {
        ...
        public static class Thumbnails implements BaseColumns {
            ...
            protected static final String SQL_FIELDS = _ID + " INTEGER PRIMARY KEY," + //
                    ...
                    WIDTH + " INTEGER," + //
                    HEIGHT + " INTEGER";
            protected static final String SQL_INDEX_VIDEO_ID = "CREATE INDEX IF NOT EXISTS video_id_index on " +
                    "videothumbnails(video_id);";
            ...
            public static Bitmap getThumbnail(Context ctx, ContentResolver cr, long origId, int kind, BitmapFactory
                    .Options options) {
                return InternalThumbnails.getThumbnail(ctx, cr, origId, InternalThumbnails.DEFAULT_GROUP_ID, kind,
                        options, CONTENT_URI);
            }
    ...
    private static class InternalThumbnails implements BaseColumns {
        ...
        private static Bitmap getMiniThumbFromFile(Cursor c, Uri baseUri, ContentResolver cr, BitmapFactory.Options
                options) {
            Bitmap bitmap = null;
            Uri thumbUri = null;
            try {
        ...
        static void cancelThumbnailRequest(ContentResolver cr, long origId, Uri baseUri, long groupId) {
            Uri cancelUri = baseUri.buildUpon().appendQueryParameter("cancel", "1").appendQueryParameter("orig_id",
                    String.valueOf(origId)).appendQueryParameter("group_id", String.valueOf(groupId)).build();
            Cursor c = null;
            try {
        ...
        static Bitmap getThumbnail(Context ctx, ContentResolver cr, long origId, long groupId, int kind,
                                   BitmapFactory.Options options, Uri baseUri) {
            Bitmap bitmap = null;
