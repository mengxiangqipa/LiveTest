...
public class MediaController extends FrameLayout {
    ...
    private void initControllerView(View v) {
        ...
        mProgress = (SeekBar) v.findViewById(getResources().getIdentifier("mediacontroller_seekbar", "id", mContext
                .getPackageName()));
        if (mProgress != null) {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (event.getRepeatCount() == 0 && (keyCode == KeyEvent.KEYCODE_HEADSETHOOK || keyCode == KeyEvent
