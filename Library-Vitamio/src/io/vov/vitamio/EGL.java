...
public class EGL {
        ...
        if (!mEgl.eglSwapBuffers(mEglDisplay, mEglSurface)) {
            ...
            switch (error) {
                ...
                case EGL10.EGL_BAD_NATIVE_WINDOW:
                    Log.e("EglHelper", "eglSwapBuffers returned EGL_BAD_NATIVE_WINDOW. tid=" + Thread.currentThread()
                            .getId());
                    break;
    ...
    private class ComponentSizeChooser extends EGLConfigChooser {
        ...
        public ComponentSizeChooser(int redSize, int greenSize, int blueSize, int alphaSize, int depthSize, int
                stencilSize) {
