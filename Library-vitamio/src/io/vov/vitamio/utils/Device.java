...
public class Device {
    ...
    public static String getIdentifiers(Context ctx) {
        ...
        sb.append(getPair("android_id", Settings.Secure.getString(ctx.getContentResolver(), Settings.Secure
                .ANDROID_ID)));
        ...
        sb.append(getPair("network_type", cm.getActiveNetworkInfo() == null ? "-1" : String.valueOf(cm
