    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AsyncTask<Object, Object, Boolean>() {
            ...
            protected void onPreExecute() {
                ...
                mPD.setMessage(InitActivity.this.getString(getResources().getIdentifier("vitamio_init_decoders",
            ...
            protected Boolean doInBackground(Object... params) {
                return Vitamio.initialize(InitActivity.this, getResources().getIdentifier("libarm", "raw",
                        getPackageName()));
            }
